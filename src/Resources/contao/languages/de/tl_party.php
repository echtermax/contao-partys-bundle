...
// Buttons
$GLOBALS['TL_LANG']['tl_party']['new'] = ['Neue Party', 'Eine neue Party erstellen'];
$GLOBALS['TL_LANG']['tl_party']['edit'] = ['Party bearbeiten', 'Party ID %s bearbeiten'];
$GLOBALS['TL_LANG']['tl_party']['copy'] = ['Party duplizieren', 'Party ID %s duplizieren'];
$GLOBALS['TL_LANG']['tl_party']['delete'] = ['Party löschen', 'Party ID %s löschen'];
$GLOBALS['TL_LANG']['tl_party']['show'] = ['Party-Details', 'Details der Party ID %s anzeigen'];
$GLOBALS['TL_LANG']['tl_party']['toggle'] = ['Party veröffentlichen/verstecken', 'Party ID %s veröffentlichen/verstecken'];
